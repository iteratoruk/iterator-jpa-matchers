...
public final class JpaMatchers {
    ...
    public static <T> Matcher<Class<T>> hasJoinColumnAnnotation(String fieldName, AnnotationMap<JoinColumn> joinColumnAnnotation) {
    ...
    public static <T> Matcher<Class<T>> hasManyToManyAnnotation(String fieldName, AnnotationMap<ManyToMany> manyToManyAnnotation) {
    ...
    public static <T> Matcher<Class<T>> hasManyToOneAnnotation(String fieldName, AnnotationMap<ManyToOne> manyToOneAnnotation) {
    ...
    public static <T> Matcher<Class<T>> hasOneToManyAnnotation(String fieldName, AnnotationMap<OneToMany> oneToManyAnnotation) {
    ...
    public static <T> Matcher<Class<T>> hasTemporalAnnotation(String fieldName, TemporalType temporalType) {
        return hasFieldAnnotation(fieldName, AnnotationMap.from(Temporal.class).set("value", temporalType));
    }

    public static <T> Matcher<Class<T>> hasTemporalAnnotation(String fieldName, AnnotationMap<Temporal> temporalAnnotation) {
        return hasFieldAnnotation(fieldName, temporalAnnotation);
    }

    private static <A extends Annotation, T> Matcher<Class<T>> hasFieldAnnotation(String fieldName, AnnotationMap<A> fieldAnnotation) {
        return new FieldAnnotationMatcher<>(fieldName, fieldAnnotation);
    }

    private static <A extends Annotation, T> Matcher<Class<T>> hasTypeAnnotation(AnnotationMap<A> typeAnnotation) {
